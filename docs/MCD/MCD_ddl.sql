...
CREATE TABLE ATTRIBUER (
  PRIMARY KEY (pavillon, numero, code_caracteristique),
  pavillon             VARCHAR(42) NOT NULL,
  numero               VARCHAR(42) NOT NULL,
  code_caracteristique VARCHAR(42) NOT NULL,
  effectif             VARCHAR(42)
);
...
CREATE TABLE CARACTERISTIQUE (
  ...
  code_caracteristique VARCHAR(42) NOT NULL,
  nom_caracteristique  VARCHAR(42)
);
...
ALTER TABLE ATTRIBUER ADD FOREIGN KEY (code_caracteristique) REFERENCES CARACTERISTIQUE (code_caracteristique);
ALTER TABLE ATTRIBUER ADD FOREIGN KEY (pavillon, numero) REFERENCES LOCAL (pavillon, numero);
